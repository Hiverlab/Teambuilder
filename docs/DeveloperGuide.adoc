...
8) Lastly, everyone will be ranked according to their total scores in descending order (highest - lowest). The first 3 will be grouped together, followed by the next 3, until 3 groups have been formed.

=== Adding a New Category/Skill


.Add in your desired category/skill in `form.component.ts` in the respective array accordingly
