...
adjust their desired percentages for each category. Usage of relative percentages?
This will help to make it more intuitive to users regarding the ... , especially for those that are not familiar with the
Gallup Strengths(?)
